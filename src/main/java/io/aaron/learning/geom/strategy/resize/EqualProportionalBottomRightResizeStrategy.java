...
public class EqualProportionalBottomRightResizeStrategy implements ResizeStrategy {
    @Override
        ...
        return event -> {
            if (event.getEventType() == MouseEvent.MOUSE_DRAGGED) {
                ...
                if (container.getTranslateY() < 0.0) {
                    ...
                    point.getCanvas().translateXProperty().set(-originalWidth + height * proportion);
                    ...
                    if(allOffsetY < 0) {
                        ...
                        point.getCanvas().translateXProperty().set(point.getCanvas().getTranslateX() + offsetY * proportion);
